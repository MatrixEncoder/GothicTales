...
export const metadata: Metadata = {
  title: 'Mythical Legends',
  description: 'Explore the dark and mysterious legends that haunt our world'
};
...
export default function LegendsPage() {
  ...
  try {
    ...
    legends = filenames.map((filename) => {
    ...
    console.error('Error reading legends directory:', error);
  }
  ...
  return (
    <main className="min-h-screen gothic-container py-24">
      <div className="relative mt-16">
        ...
        <h1 className="gothic-heading text-center mb-4">Dark Legends</h1>
        <p className="text-center text-gothic-300 text-lg mb-12">
          Uncover the dark and mysterious legends that haunt our world
        </p>
        ...
        >
          {legends.map((legend) => (
            ...
            >
              <Link href={`/legend/${legend.slug}`} className="block group">
